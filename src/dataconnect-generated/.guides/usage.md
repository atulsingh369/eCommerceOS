...
```ts
import { useCreateCategory, useListProductsByCategory, useUpdateProductPrice, useGetUserOrders } from '@dataconnect/generated/react';
...
const { data, isPending, isSuccess, isError, error } = useGetUserOrders(getUserOrdersVars);
...
```js
import { createCategory, listProductsByCategory, updateProductPrice, getUserOrders } from '@dataconnect/generated';
